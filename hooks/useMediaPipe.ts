...
export const useMediaPipe = (videoRef: React.RefObject<HTMLVideoElement | null>, enabled: boolean) => {
    ...
    const startCamera = async () => {
      try {
        ...
        try {
          ...
          console.warn("Strict camera constraints rejected, running fallback standard constraints:", strictErr);
          // Fall back to general camera video stream
          stream = await navigator.mediaDevices.getUserMedia({
            video: true
          });
        }
